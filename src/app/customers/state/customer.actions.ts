...
export class LoadCustomer implements Action {
  readonly type = CustomerActions.LOAD_CUSTOMER;
...
export class LoadCustomerSuccess implements Action {
  readonly type = CustomerActions.LOAD_CUSTOMER_SUCCESS;

  constructor(public payload: Customer) { }
}

export class LoadCustomerFail implements Action {
  readonly type = CustomerActions.LOAD_CUSTOMER_FAIL;
...
export class CreateCustomer implements Action {
  readonly type = CustomerActions.CREATE_CUSTOMER;
...
export class CreateCustomerSuccess implements Action {
  readonly type = CustomerActions.CREATE_CUSTOMER_SUCCESS;
...
export class CreateCustomerFail implements Action {
  readonly type = CustomerActions.CREATE_CUSTOMER_FAIL;
...
export class UpdateCustomer implements Action {
  readonly type = CustomerActions.UPDATE_CUSTOMER;
...
export class UpdateCustomerSuccess implements Action {
  readonly type = CustomerActions.UPDATE_CUSTOMER_SUCCESS;
...
export class UpdateCustomerFail implements Action {
  readonly type = CustomerActions.UPDATE_CUSTOMER_FAIL;
...
export class DeleteCustomer implements Action {
  readonly type = CustomerActions.DELETE_CUSTOMER;
...
export class DeleteCustomerSuccess implements Action {
  readonly type = CustomerActions.DELETE_CUSTOMER_SUCCESS;
...
export class DeleteCustomerFail implements Action {
  readonly type = CustomerActions.DELETE_CUSTOMER_FAIL;
